import type { QuoteResponse, RouteComplianceResult } from './types';
...
export class RouteComplianceFilter {
   ...
   */
  filterCompliantSteps(quote: QuoteResponse): QuoteResponse | null {
    ...
    // Cannot safely use a partial multi-hop route
    return null;
  }
