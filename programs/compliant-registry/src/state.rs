...
// Import KycLevel and Jurisdiction from accredit-types
pub use accredit_types::{KycLevel, Jurisdiction};
...
impl ComplianceConfig {
    ...
    pub fn is_jurisdiction_allowed(&self, jurisdiction: &Jurisdiction) -> bool {
        accredit_types::is_jurisdiction_in_bitmask(jurisdiction, self.jurisdiction_bitmask)
    }
